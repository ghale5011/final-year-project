    ...
    // Get form and input elements for general settings
    let general_s_form = document.getElementById('general_s_form');
    let site_title_inp = document.getElementById('site_title_inp');
    let site_about_inp = document.getElementById('site_about_inp');

    // Get form element for contact settings
    ...
    // Function to Retrieve Contact Details from the Server
    function get_contacts() {
        ...
        xhr.onload = function() {
            ...
            // Update UI with fetched contact details
            for (let i = 0; i < contacts_p_id.length; i++) {
                document.getElementById(contacts_p_id[i]).innerText = contacts_data[i+1];
            }            
            iframe.src = contacts_data[9]; // Load iframe with Google Map URL
    ...
    // Function to populate contact details input fields in the modal
    ...
    // Add event listener for contact settings form submission
    ...
    function upd_contacts() {
        ...
        // Prepare data string for the AJAX request
    ...
    // Function to Remove a Member from the Team by ID
