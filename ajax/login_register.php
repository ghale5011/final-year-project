<?php 
    ...
    require("../inc/sendgrid/sendgrid-php.php"); // SendGrid library for email functionality
    ...
    function send_mail($uemail,$token,$type)
    {
      if ($type == "email_confirmation"){
        ...
        $email->addContent(
            "text/html", 
            "
              Please click the link to $content: <br>
    ...
    if(isset($_POST['forgot_pass']))
    {
      ...
      else
      {
        ...
        if($u_fetch['is_verified']==0){
          ...
          {
            $date = date("Y-m-d"); // reset will be in current date only
